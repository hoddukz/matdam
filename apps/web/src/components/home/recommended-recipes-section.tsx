// Tag: core
// Path: apps/web/src/components/home/recommended-recipes-section.tsx
...
type RecommendedRecipesSectionProps = {
  locale: string;
...
export function RecommendedRecipesSection({ locale, recipes, t }: RecommendedRecipesSectionProps) {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="mt-1 text-sm text-muted-foreground">{t.recommendedSubtitle}</p>
      </div>
